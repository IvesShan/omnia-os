"""
Omnia Chat Engine with Recurrent Reasoning - Test Script
...
from core.openmythos.act_planner import ACTPlanner, ComplexityLevel, TaskAnalysis
from core.openmythos.recurrent_engine import RecurrentReasoning, ReasoningResult
from core.providers.qianfan_client import QianfanClient
...
class OmniaChatEngine:
    ...
    def chat(
        ...
        # 2. 根据复杂度决定推理深度
        if analysis.complexity == ComplexityLevel.QUICK:
            # 简单任务：直接回答
        ...
        elif analysis.complexity == ComplexityLevel.BALANCED:
            # 中等任务：2-4 轮推理
